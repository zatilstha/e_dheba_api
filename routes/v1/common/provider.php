...
$router->post('/store_api', 'V1\Common\User\UserAuthController@store_api_test'); //store to API
$router->post('/wallet_test', 'V1\Common\Provider\HomeController@wallet_api'); 
...
$router->group(['middleware' => 'auth:provider'], function($app) {
    ...
    $app->post('/walletupdate', 'V1\Common\Provider\HomeController@wallet_update');
