...
$router->post('/testotp', 'V1\Common\User\UserAuthController@testotp');
...
$router->group(['middleware' => 'auth:user'], function($app) {
    ...
    $app->get('/menus', 'V1\Common\User\HomeController@index');
    $app->get('/service_menus', 'V1\Common\User\HomeController@menus');
    ...
    $app->post('/walletupdate', 'V1\Common\User\HomeController@wallet_update');
    ...
    //DebitAdmin Wallet
    // $app->get('/debitamount', 'V1\Common\User\HomeController@debit_amount');
