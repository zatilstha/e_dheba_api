...
$router->get('/hbl/form', 'V1\Common\PaymentController@hbl_form');
...
$router->group(['prefix' => 'api/v1'], function ($app) {
	...
	$app->get('/hbl/form', 'V1\Common\PaymentController@hbl_form');
	...
	$app->get('hbl/amount', 'V1\Common\CommonController@hbl_amount_hash');
