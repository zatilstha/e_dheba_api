...
class CreateRideRequestDisputesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up() 
    {
        Schema::connection('transport')->create('ride_request_disputes', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ride_request_disputes');
    }
}
