...
class User extends BaseModel implements JWTSubject, AuthenticatableContract, AuthorizableContract
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'gender', 'email', 'mobile', 'picture', 'password', 'device_type','jwt_token','login_by', 'device_token', 'payment_mode','social_unique_id','device_id','wallet_balance','referral_unique_id', 'user_type','qrcode_url','country_code','company_id','country_id','city_id','state_id'
    ];
