...
class DbClearCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if($setting->clear_seed == 1) {
            ...
            DB::table('store_order_disputes')->delete();
            DB::table('store_order_invoices')->delete();
            DB::table('store_order_statuses')->delete();
            DB::table('store_wallets')->delete();
            DB::table('store_carts')->delete();
            DB::table('store_cart_item_addons')->delete();
        }    
