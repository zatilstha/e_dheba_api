...
class UserSwaggerController extends Controller
{
	...
	*			@OA\JsonContent(ref="#/components/schemas/UserSendOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\JsonContent(ref="#/components/schemas/UserVerifyOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\JsonContent(ref="#/components/schemas/UserWalletMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
