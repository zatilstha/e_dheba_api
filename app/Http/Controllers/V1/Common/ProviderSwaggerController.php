...
class ProviderSwaggerController extends Controller
{
	...
	*			@OA\JsonContent(ref="#/components/schemas/ProviderSendOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\JsonContent(ref="#/components/schemas/ProviderVerifyOTPInput"))
	*	),
	*	@OA\Response(
	*		response="200",
	*		description="Password changed successfully",
	...
	*		@OA\MediaType(
	*			mediaType="multipart/form-data",
	*			@OA\JsonContent(ref="#/components/schemas/ProviderWalletMoneyInput"))
	*	),
	*	@OA\Response(
	*		response="200",
